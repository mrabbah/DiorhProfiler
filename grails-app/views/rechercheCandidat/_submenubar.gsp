...
&&	params.controller != 'home'
  ...
  <div id="jCrumbs" class="breadCrumb nav-pills module">
    <ul>
      ...
      <a id="sendmail" href="#"><img class="logo" src="${resource(plugin: 'kickstart', dir:'images/icon', file:'email.png')}" alt="${meta(name:'app.name')}" width="18px" height="18px"/><g:message code="default.sendmail.label"  args="[entityName]"/></a>
      </li>      
      <g:if test="${ params.action == 'show' || params.action == 'edit' }">
        <!-- the item is an object (not a list) -->
        <li class="${ params.action == "edit" ? 'actives' : '' }">
        <g:link action="edit" id="${params.id}"><img class="logo" src="${resource(plugin: 'kickstart', dir:'images/icon', file:'edit.png')}" alt="${meta(name:'app.name')}" width="18px" height="18px"/><g:message code="default.list.label" args="[entityName]"/><g:message code="default.edit.label"  args="[entityName]"/></g:link>
        </li>
        <li class="">
