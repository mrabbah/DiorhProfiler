            ...
            <div class="row">  
              ...
              <div class="col-sm-10">
                <div class="form-actions margin-top-medium">
                  <g:submitButton name="sendmail" class="btn btn-danger" onclick="validersendmail('candidat'); return false;" value="${message(code: 'default.button.envoyermail.label', default: 'Create')}" />
                </div>
              </div>
            </div>
          </g:form>
