  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel panel-danger">
        ...
        <g:set var="cle" value="${params.motcle?.trim()}" />
        <div class="panel-body">
          <g:if test="${session.user!=null}">
          <g:link action="precedent_motcle" id="${candidatInstance.id} " params="[index:i ]" style="color:red">Precedent</g:link>
          <g:link action="suivant_motcle" id="${candidatInstance.id}" style="color:red" params="[index:i]">Suivant</g:link>
          </g:if>
                ...
                <div class="tab-pane ${session.href!=null && session.href=='#tab_br4' ? "active" : ""}" id="tab_br4">
                  ...
                  <table border="0" class="showcnd">
                    ...
                    <div class="row">
                      ...
                      <g:if test="${candidatInstance?.profil1!=null && candidatInstance?.profil1!='null' && candidatInstance?.profil1!=''}">
                      ...
                      <g:if test="${candidatInstance?.annotation1!=null && candidatInstance?.annotation1!='null' && candidatInstance?.annotation1!=''}">
