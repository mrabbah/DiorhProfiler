    ...
    <div class="col-sm-12">
      <div class="panel panel-danger">
        ...
        <div class="panel-body">
          <g:if test="${session.user!=null}">
          <g:link action="precedent" id="${candidatInstance.id} " params="[index:i ]" style="color:red">Precedent</g:link>
          <g:link action="suivant" id="${candidatInstance.id}" style="color:red" params="[index:i ]">Suivant</g:link>
          </g:if>
